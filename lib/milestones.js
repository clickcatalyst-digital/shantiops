...
// Settings access matrix. Engineering owns the BOM (no milestones of its own).
export const DEPARTMENTS = ['Design', 'Engineering', 'Procurement', 'Production', 'QC', 'Dispatch', 'Installation'];
